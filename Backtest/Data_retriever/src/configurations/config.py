...
class config_manager:
    ...
    def json_file_path():
        yaml_file=read_yaml(CONFIG_FILE_PATH)
        json_path=yaml_file["backtest"]["data_saving"]["json_file_path"]


        return json_path
    def data_loading_config():
        yaml_file=read_yaml(CONFIG_FILE_PATH)
        symbol_list=yaml_file["backtest"]['data_loading_configs']['symbol_list']
    ...
    def csv_file_path():
        yaml_file=read_yaml(CONFIG_FILE_PATH)
        csv_path=yaml_file["backtest"]["data_saving"]["csv_path"]
